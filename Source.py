...
class Widget(QTabWidget):
    ...
    def setupUi(self, TabWidget):
        ...
        TabWidget.setWindowTitle("Talk and i write IA")
    ...
    def speech_to_text(self): # Funcion para pasar de voz a texto
        ...
        try:
           ...
           salida2 =  ("Recognition.ai dice: " + r.recognize_wit(audio, key=WIT_AI_KEY)) # Guardamos la salida en una variable
        except sr.UnknownValueError: # Definimos excepciones que se puedan presentar
            salida2 = ("No pudo entender el audio")
        except sr.RequestError as e:
            salida2 = ("no se pueden usar los servicios; {0}".format(e))
